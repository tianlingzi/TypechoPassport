...
<div class="main-container">
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-icon">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/>
                </svg>
            </div>
            <h2 class="card-title">重置密码</h2>
            <p class="card-description">请设置您的新密码，请确保密码安全强度足够。</p>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                // 显示成功通知
                showNotification('success', '重置密码成功');
        ...
        if (passwordInput) {
            ...
            passwordInput.addEventListener('input', function() {
                ...
                if (password.match(/[a-z]/) && password.match(/[A-Z]/)) strengthLevel++;
